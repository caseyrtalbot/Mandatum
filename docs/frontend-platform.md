...
generated Help from `FrameSnapshot` scene/theme data. Phase 3 remains underway;
multi-pane layouts, the Welcome overlay, and broader input parity are still
explicit gaps.
...
session-output Search plus generated Help. Restore, multi-pane layouts,
